-- =============================================================================
-- Fund GL Segment Values
-- APEX REST Sync table: GL valueSets/Fund/child/values
-- Module static ID: rest_sync_fund_values
-- Sync type: INCREMENTAL (LastUpdateDate filter)
-- Created by APEX REST Data Source sync; APEX$ columns managed by APEX
-- =============================================================================
CREATE TABLE FUND_VALUES_R (
    ...
    CONSTRAINT FUND_VALUES_R_PK PRIMARY KEY (APEX$RESOURCEKEY)
);
