-- =============================================================================
-- Activity GL Segment Values
-- APEX REST Sync table: GL valueSets/Activity/child/values
-- Module static ID: rest_sync_activity_values
-- Sync type: INCREMENTAL (LastUpdateDate filter)
-- Created by APEX REST Data Source sync; APEX$ columns managed by APEX
-- =============================================================================
CREATE TABLE ACTIVITY_VALUES_R (
    ...
    CONSTRAINT ACTIVITY_VALUES_R_PK PRIMARY KEY (APEX$RESOURCEKEY)
);
