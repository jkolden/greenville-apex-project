-- =============================================================================
-- Interfund GL Segment Values
-- APEX REST Sync table: GL valueSets/InterFund/child/values
-- Module static ID: rest_sync_interfund_values
-- Sync type: INCREMENTAL (LastUpdateDate filter)
-- Created by APEX REST Data Source sync; APEX$ columns managed by APEX
-- =============================================================================
CREATE TABLE INTERFUND_VALUES_R (
    ...
    CONSTRAINT INTERFUND_VALUES_R_PK PRIMARY KEY (APEX$RESOURCEKEY)
);
