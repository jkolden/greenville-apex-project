-- =============================================================================
-- Accounting Scenario GL Segment Values
-- APEX REST Sync table: GL valueSets/AccountScenario/child/values
-- Module static ID: rest_sync_accounting_scenario_values
-- Sync type: INCREMENTAL (LastUpdateDate filter)
-- Created by APEX REST Data Source sync; APEX$ columns managed by APEX
-- =============================================================================
CREATE TABLE ACCTG_SCENARIO_VALUES_R (
    ...
    CONSTRAINT ACCTG_SCENARIO_VALUES_R_PK PRIMARY KEY (APEX$RESOURCEKEY)
);
