-- =============================================================================
-- Location GL Segment Values
-- APEX REST Sync table: GL valueSets/Location/child/values
-- Module static ID: rest_sync_location_values
-- Sync type: INCREMENTAL (LastUpdateDate filter)
-- Created by APEX REST Data Source sync; APEX$ columns managed by APEX
-- =============================================================================
CREATE TABLE LOCATION_VALUES_R (
    ...
    CONSTRAINT LOCATION_VALUES_R_PK PRIMARY KEY (APEX$RESOURCEKEY)
);
