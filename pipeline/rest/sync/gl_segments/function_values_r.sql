-- =============================================================================
-- Function GL Segment Values
-- APEX REST Sync table: GL valueSets/Function1/child/values
-- Module static ID: rest_sync_function_values
-- Sync type: INCREMENTAL (LastUpdateDate filter)
-- Created by APEX REST Data Source sync; APEX$ columns managed by APEX
-- =============================================================================
CREATE TABLE FUNCTION_VALUES_R (
    ...
    CONSTRAINT FUNCTION_VALUES_R_PK PRIMARY KEY (APEX$RESOURCEKEY)
);
