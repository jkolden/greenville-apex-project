-- =============================================================================
-- Grant GL Segment Values
-- APEX REST Sync table: GL valueSets/Grant/child/values
-- Module static ID: rest_sync_grant_values
-- Sync type: INCREMENTAL (LastUpdateDate filter)
-- Created by APEX REST Data Source sync; APEX$ columns managed by APEX
-- =============================================================================
CREATE TABLE GRANT_VALUES_R (
    ...
    CONSTRAINT GRANT_VALUES_R_PK PRIMARY KEY (APEX$RESOURCEKEY)
);
